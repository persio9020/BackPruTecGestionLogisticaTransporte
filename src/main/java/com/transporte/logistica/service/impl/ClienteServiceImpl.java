...
public class ClienteServiceImpl implements ClienteService {
  ...
  @Autowired
  public ClienteServiceImpl(ClienteRepository clienteRepository, ClientesResponseMapper clientesResponseMapper) {
  ...
  public Mono<ResponseEntity<String>> guardarCliente(ClienteRequest clienteRequest) {
    try {
      ...
      cliente.setSexoId(new Sexo(clienteRequest.getSexoId()));
